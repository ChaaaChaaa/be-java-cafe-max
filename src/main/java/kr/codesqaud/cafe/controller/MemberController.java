...
public class MemberController {
	...
	@PostMapping
	public String register(@Valid @ModelAttribute MemberJoinRequestDto memberJoinRequestDto,
	...
	@PostMapping("/login")
	public String login(@ModelAttribute @Valid MemberLoginRequestDto memberLoginRequestDto, BindingResult bindingResult,
	...
	public String editProfile(@PathVariable String email, @Valid ProfileEditRequestDto profileEditRequestDto,
	...
	public String profileEditForm(@PathVariable String email, Model model,
		@SessionAttribute("loginMember") LoginMemberSession loginMemberSession) {
		...
		model.addAttribute("profileEditRequestDto",
			ProfileEditRequestDto.of(memberService.findById(memberResponseDto.getMemberId())));
