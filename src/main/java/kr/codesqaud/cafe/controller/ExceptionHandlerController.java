...
public class ExceptionHandlerController {
	...
	public ModelAndView commonExceptionHandler(CommonException commonException) {
		...
		modelAndView.addObject("error",
			new ErrorDto(commonExceptionType.getStatus().value(), commonExceptionType.getErrorMessage()));
	...
	public String userDuplicatedInfoExceptionHandler(MemberProfileEditException memberProfileEditException,
		Model model) {
