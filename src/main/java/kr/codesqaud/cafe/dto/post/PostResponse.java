...
public class PostResponse {
	...
	public PostResponse(Long id, String title, String content, WriterResponse writer, LocalDateTime writeDate,
		Long views) {
		this.id = id;
		this.title = title;
	...
	public static PostResponse of(Post post, WriterResponse writerResponse) {
		return new PostResponse(post.getId(), post.getTitle(), post.getContent(), writerResponse, post.getWriteDate(),
			post.getViews());
	}
